...
class EvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create evaluacion" do
    assert_difference('Evaluacion.count') do
      post evaluacions_url, params: { evaluacion: { fecha: @evaluacion.fecha, hora: @evaluacion.hora, id_evaluacion: @evaluacion.id_evaluacion, repetir: @evaluacion.repetir } }
    end
  ...
  test "should update evaluacion" do
    patch evaluacion_url(@evaluacion), params: { evaluacion: { fecha: @evaluacion.fecha, hora: @evaluacion.hora, id_evaluacion: @evaluacion.id_evaluacion, repetir: @evaluacion.repetir } }
