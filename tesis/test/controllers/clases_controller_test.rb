...
class ClasesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create clase" do
    assert_difference('Clase.count') do
      post clases_url, params: { clase: { clase_id: @clase.clase_id, descripcion_clase: @clase.descripcion_clase, nombre_clase: @clase.nombre_clase } }
    end
  ...
  test "should update clase" do
    patch clase_url(@clase), params: { clase: { clase_id: @clase.clase_id, descripcion_clase: @clase.descripcion_clase, nombre_clase: @clase.nombre_clase } }
