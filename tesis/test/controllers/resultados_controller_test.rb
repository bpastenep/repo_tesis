...
class ResultadosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create resultado" do
    assert_difference('Resultado.count') do
      post resultados_url, params: { resultado: { integer: @resultado.integer, puntaje_max: @resultado.puntaje_max, punteje_obtenido: @resultado.punteje_obtenido, resultado_id: @resultado.resultado_id } }
    end
  ...
  test "should update resultado" do
    patch resultado_url(@resultado), params: { resultado: { integer: @resultado.integer, puntaje_max: @resultado.puntaje_max, punteje_obtenido: @resultado.punteje_obtenido, resultado_id: @resultado.resultado_id } }
