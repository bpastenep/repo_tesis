...
class ContenidosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create contenido" do
    assert_difference('Contenido.count') do
      post contenidos_url, params: { contenido: { contenido_id: @contenido.contenido_id, descripcion_contenido: @contenido.descripcion_contenido } }
    end
  ...
  test "should update contenido" do
    patch contenido_url(@contenido), params: { contenido: { contenido_id: @contenido.contenido_id, descripcion_contenido: @contenido.descripcion_contenido } }
