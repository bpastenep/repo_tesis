...
class TipoEvaluacionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create tipo_evaluacion" do
    assert_difference('TipoEvaluacion.count') do
      post tipo_evaluacions_url, params: { tipo_evaluacion: { descripcion_tipo_evaluacion: @tipo_evaluacion.descripcion_tipo_evaluacion, tipo_evaluacion_id: @tipo_evaluacion.tipo_evaluacion_id } }
    end
  ...
  test "should update tipo_evaluacion" do
    patch tipo_evaluacion_url(@tipo_evaluacion), params: { tipo_evaluacion: { descripcion_tipo_evaluacion: @tipo_evaluacion.descripcion_tipo_evaluacion, tipo_evaluacion_id: @tipo_evaluacion.tipo_evaluacion_id } }
